...
void startSeWithManualControl(const al::IUseAudioKeeper*, const sead::SafeString&, const al::SePlayParamList*, const char*, const sead::Vector3f*);
bool tryStartSeWithManualControl(const al::IUseAudioKeeper*, const sead::SafeString&, const al::SePlayParamList*, const char*, const sead::Vector3f*);
void holdSeWithManualControl(const al::IUseAudioKeeper*, const sead::SafeString&, const al::SePlayParamList*, const char*, const sead::Vector3f*);
bool tryHoldSeWithManualControl(const al::IUseAudioKeeper*, const sead::SafeString&, const al::SePlayParamList*, const char*, const sead::Vector3f*);
