...
bool listenStageSwitchOnOff(al::IUseStageSwitch*, const char*, const al::FunctorBase&, const al::FunctorBase&);
bool listenStageSwitchOnOffAppear(al::IUseStageSwitch*, const al::FunctorBase&, const al::FunctorBase&);
bool listenStageSwitchOnOffKill(al::IUseStageSwitch*, const al::FunctorBase&, const al::FunctorBase&);
bool listenStageSwitchOnOffStart(al::IUseStageSwitch*, const al::FunctorBase&, const al::FunctorBase&);
