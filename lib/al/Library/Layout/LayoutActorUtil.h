...
const sead::Vector3f& getLocalScale(const al::IUseLayout*);
...
const al::Matrix43f& getPaneMtx(const al::IUseLayout*, const char*);
const al::Matrix43f* getPaneMtxRaw(const al::IUseLayout*, const char*);
...
const sead::Vector3f& getPaneLocalTrans(const al::IUseLayout*, const char*);
void getPaneLocalSize(sead::Vector2f*, const al::IUseLayout*, const char*);
const sead::Vector3f& getPaneLocalRotate(const al::IUseLayout*, const char*);
const sead::Vector3f& getPaneLocalScale(const al::IUseLayout*, const char*);
const sead::Vector3f& getTextBoxDrawRectSize(const al::IUseLayout*, const char*);
