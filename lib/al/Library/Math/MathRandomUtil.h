...
sead::Vector3f getRandomDirH(sead::Vector3f*, sead::Vector3f const&);
void rotateVectorDegree(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, f32);
sead::Vector2f getRandomOnCircle(sead::Vector2<f32>*, f32);
sead::Vector2f getRandomInCircle(sead::Vector2<f32>*, f32);
sead::Vector2f getRandomInCircleMinMaxRadius(sead::Vector2<f32>*, f32, f32);
sead::Vector2f getRandomInCircle(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, f32);
sead::Vector3f getRandomOnSphere(sead::Vector3f*, f32);
sead::Vector3f getRandomInSphere(sead::Vector3f*, f32);
void calcRandomDirInCone(sead::Vector3f*, sead::Vector3f const&, f32);
void getRandomInSphereMinMaxRadius(sead::Vector3f*, f32, f32);
void initRandomSeed(u32);
void initRandomSeedByTick();
void initRandomSeedByString(char const*);
