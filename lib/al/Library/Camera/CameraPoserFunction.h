...
namespace alCameraPoserFunction {
    ...
    bool tryCalcSlopeCollisionDownFrontDirH(sead::Vector3<float> *, const al::CameraPoser *);
    ...
    void checkFirstCameraCollisionArrow(sead::Vector3<float> *, sead::Vector3<float> *, const al::IUseCollision *, const sead::Vector3<float> &, const sead::Vector3<float> &);
    void checkFirstCameraCollisionArrow(alCameraPoserFunction::CameraCollisionHitResult *, const al::IUseCollision *, const sead::Vector3<float> &, const sead::Vector3<float> &);
    void checkFirstCameraCollisionArrowOnlyCeiling(sead::Vector3<float> *, sead::Vector3<float> *, const al::IUseCollision *, const sead::Vector3<float> &, const sead::Vector3<float> &);
    ...
    bool tryFindNearestLimitRailKeeper(const al::CameraPoser *, const sead::Vector3<float> &);
    sead::Vector2<float> calcCameraRotateStick(sead::Vector2<float> *, const al::CameraPoser *);
    ...
    bool tryCalcCameraSnapShotMoveStick(sead::Vector2<float> *, const al::CameraPoser *);
