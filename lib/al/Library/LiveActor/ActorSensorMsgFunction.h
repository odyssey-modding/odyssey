...
// TODO: This defines the class but the sead decomp doesn't have anything inside the RTTI functions, causing the functions in the vtable to be
// exported
