...
void ActorInitInfo::initNew(const PlacementInfo* placementInfo, const LayoutInitInfo* layoutInitInfo, LiveActorGroup* allActorsGroup,
                            const ActorFactory* actorFactory, ActorResourceHolder* actorResourceHolder, AreaObjDirector* areaObjDirector,
                            AudioDirector* audioDirector, CameraDirector* cameraDirector, ClippingDirector* clippingDirector,
                            CollisionDirector* collisionDirector, DemoDirector* demoDirector, EffectSystemInfo* effectSystemInfo,
                            ExecuteDirector* executeDirector, GameDataHolderBase* gameDataHolder, GravityHolder* gravityHolder,
                            HitSensorDirector* hitSensorDirector, ItemDirectorBase* itemDirector, NatureDirector* natureDirector,
                            const GamePadSystem* gamePadSystem, PadRumbleDirector* padRumbleDirector, PlayerHolder* playerHolder,
                            SceneObjHolder* sceneObjHolder, SceneMsgCtrl* sceneMsgCtrl, SceneStopCtrl* sceneStopCtrl,
                            ScreenCoverCtrl* screenCoverCtrl, ScreenPointDirector* screenPointDirector, ShadowDirector* shadowDirector,
                            StageSwitchDirector* stageSwitchDirector, ModelGroup* modelGroup, GraphicsSystemInfo* graphicsSystemInfo,
                            ModelDrawBufferCounter* modelDrawBufferCounter, LiveActorGroup* kitDrawingGroup) {
    ...
    mViewIdHolder = al::ViewIdHolder::tryCreate(*placementInfo);
}
