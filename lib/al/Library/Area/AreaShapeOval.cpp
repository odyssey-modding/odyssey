#include "al/Library/Area/AreaShapeOval.h"
...
bool AreaShapeOval::calcNearestEdgePoint(sead::Vector3f* edgePoint, const sead::Vector3f& trans) const {
    sead::Vector3f localPos = sead::Vector3f::zero;
    calcLocalPos(&localPos, trans);
...
// bool AreaShapeOval::checkArrowCollision(sead::Vector3f*, sead::Vector3f*, const sead::Vector3f&, const sead::Vector3f&) const
