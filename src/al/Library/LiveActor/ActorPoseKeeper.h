...
void getGravity(const al::LiveActor* actor);
void getTrans(const al::LiveActor* actor);
void getScale(const al::LiveActor* actor);
...
void getTransPtr(al::LiveActor* actor);
...
void getFront(const al::LiveActor* actor);
void getFrontPtr(al::LiveActor* actor);
