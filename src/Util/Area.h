...
void calc2DAreaLockDir(sead::Vector3f*, const al::AreaObj*, const sead::Vector3f&);
...
void calcFindWaterAreaSurfaceNoWaveByArrow(const al::LiveActor*, sead::Vector3f*, sead::Vector3f*, const sead::Vector3f&, const sead::Vector3f&);
bool isPushOut2DAreaOpposite(const al::AreaObj*);
bool isFaceTo2DAreaPushOutDir(const al::AreaObj*);
void calc2DAreaFreeDir(sead::Vector3f*, const al::AreaObj*, const sead::Vector3f&);
void calc2DAreaGravity(sead::Vector3f*, const al::AreaObj*, const sead::Vector3f&);
void calc2DAreaSnapPower(sead::Vector3f*, f32*, const al::AreaObj*, const sead::Vector3f&);
void calc2DAreaDistanceGravity(sead::Vector3f*, const al::AreaObj*, const sead::Vector3f&);
f32 get2DAreaSurfaceDistance(const al::AreaObj*);
void calc2DAreaSnapPowerSurfaceDistance(sead::Vector3f*, f32*, const al::AreaObj*, const sead::Vector3f&, f32);
void calcExtForceAreaVelocity(sead::Vector3f*, const al::IUseAreaObj*, const sead::Vector3f&, const sead::Vector3f&, const sead::Vector3f&);
