...
CapTargetInfo* createCapTargetInfoWithPlayerCollider(al::LiveActor*, IUsePlayerCollision*, const char*);
...
bool isHackerStopMoveGround(const al::LiveActor*, const IUsePlayerHack*, f32, const IUsePlayerCollision*);
