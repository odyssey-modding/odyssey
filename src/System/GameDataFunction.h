...
void tryGetNextMainScenarioLabel(sead::BufferedSafeString*, sead::BufferedSafeString*, const al::IUseSceneObjHolder*);
...
void makeTextureSaveDataFileName(sead::BufferedSafeString*, const nn::g3d::ResFile*, const GameDataHolder*, s32);
